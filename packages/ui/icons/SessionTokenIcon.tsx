...
export const SessionTokenIcon = forwardRef<SVGSVGElement, SVGAttributes>((props, ref) => (
  ...
  >
    ...
    <g clip-path="url(#a)">
      ...
      <path
        fill="url(#c)"
        d="M158.2 190.1h122.4v97.3H158.2z"
        transform="rotate(-120 219.34 238.7)"
      />
    ...
    <g clip-path="url(#e)">
      ...
      <path
        fill="url(#g)"
        d="M-16.6 194.3h136.4v119.3H-16.6z"
        transform="rotate(-135 51.54 253.97)"
      />
      <path fill="url(#h)" d="M89.9 112.9h126.3V210H89.9z" transform="rotate(60 153.06 161.5)" />
    </g>
  </svg>
));
